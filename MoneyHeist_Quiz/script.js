...
var HTMLquestions=[

    {
        ...
        choices: ["Alzheimer's Disease","Paranoid Schizophrenia","Post-Traumatic Stress Disorder","Stockholm Syndrome"],
        answer: 1
    ...
    
    {
        ...
        choices: ["976","926","984","998"],
        answer: 3
    
    },
    {
        question: "The Professor's first name is eventually revealed. What is it?",
        choices: ["Andres","Anibal","Sergio","Cortes"],
        answer: 3
    
    },
    {
        question: "Before giving up on society and turning to a life of crime, what was Moscow's occupation?",
        choices: ["Hacker","Miner","Soldier","Driver"],
        answer: 2
    
    },
    {/*5*/
        question: "Which continent is *not* represented with a nickname of the robbers? ",
        choices: ["Africa","Asia","Oceania","Australia"],
        answer: 3
    
    },
    {
        question: "At the end of Part 2, in which country does Raquel track down The Professor?",
        choices: ["Barbados","Philippines","Thailand","Australia"],
        answer: 2
    
    }, 
    {
        question: "Who is responsible for this quote? “Are you a complete idiot, or what? You’ve heard of Stockholm Syndrome, right?”",
        choices: ["Nairobi","Arturo","Denver","Berlin"],
        answer: 1
    
    }, 
    {
        question: "Who says the following? “Thieves are caught on the run. We need to rile 'em up a bit.”",
        choices: ["Alicia","Angel","Raquel","Professor"],
        answer: 3
    
    }, 
    {
        question: "What is the name of Berlin’s girlfriend who comes to visit at the monastery?",
        choices: ["Alicia","Monica","Vincet","Tatiana"],
        answer: 4
    
    }, 
    {/*10*/
        question: "On what date did the first episode of ‘Money Heist’ air in Spain?",
        choices: ["April 8th, 2017","May 7th, 2017","May 17th, 2017","March 17th, 2017"],
        answer: 3
